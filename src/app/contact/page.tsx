            ...
            <div className="pt-8 border-t border-gray-100">
              ...
              <div className="flex space-x-4">
                <a 
                  ...
                  className="p-3 bg-gray-50 rounded-xl hover:bg-primary hover:text-white transition-all"
                >
                ...
                <a 
                  ...
                  target="_blank" 
                  rel="noopener noreferrer" 
                  className="p-3 bg-gray-50 rounded-xl hover:bg-[#1877F2] hover:text-white transition-all"
                >
                ...
                <a 
                  href="https://gymdate.in" 
                  target="_blank" 
                  rel="noopener noreferrer" 
                  className="p-3 bg-gray-50 rounded-xl hover:bg-secondary hover:text-white transition-all"
                >
