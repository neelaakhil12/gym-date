  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <div className="flex items-center space-x-4">
        ...
        <div>
          <h1 className="text-2xl font-black text-secondary">Edit My Gym</h1>
          <p className="text-gray-500 mt-1">Update your public gym profile.</p>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-8 pb-10">
              ...
              <div className="space-y-2 md:col-span-2">
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    placeholder="Paste Google Maps link or use 'Locate Me'"
              ...
              <div className="space-y-4 pt-4 border-t border-gray-100 md:col-span-2">
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-xs text-gray-500">Enable a discount badge on your gym profile.</p>
                  </div>
                  <button
                    type="button"
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <textarea
                  ...
                  placeholder="Paste your description here. Use points like 1, 2, 3 or - to create bullets."
        ...
        <div className="flex justify-end">
          <button
            type="submit"
            disabled={loading}
            className="bg-primary text-white px-8 py-3.5 rounded-xl font-bold hover:bg-red-700 transition-all shadow-md disabled:opacity-70 flex items-center space-x-2"
          >
            {loading ? (
              <div className="animate-spin rounded-full h-5 w-5 border-t-2 border-b-2 border-white"></div>
            ) : (
              <span>Save Gym Profile</span>
            )}
          </button>
        </div>
      </form>
