...
export default function WhatsAppButton({ 
  phoneNumber = "9100061091", // Default business number
  message = "Hello! I am interested in partnering with GymDate." 
}: WhatsAppButtonProps) {
  const openWhatsApp = () => {
  ...
  return (
    <button
      ...
      className="fixed bottom-8 right-8 z-50 flex items-center justify-center w-16 h-16 bg-[#25D366] text-white rounded-full shadow-2xl hover:scale-110 active:scale-95 transition-all duration-300 group animate-bounce-subtle"
